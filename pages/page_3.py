...
with col3:
    st.image(load_image('image11.jpeg'), use_column_width=True, caption="Image 3")
with col4:
    st.image(load_image('image12.jpeg'), use_column_width=True, caption="Image 4")
...
if uploaded_file is not None:
    user_image = Image.open(uploaded_file)
        ...
        # Load model image
    model_image1 = load_image('image9.jpeg')
    model_image2 = load_image('image10.jpeg')

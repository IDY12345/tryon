...
with col1:
    st.image(load_image('image13.jpeg'), use_column_width=True, caption="Image 1")
with col2:
    st.image(load_image('image14.jpeg'), use_column_width=True, caption="Image 2")
with col3:
    st.image(load_image('image15.jpeg'), use_column_width=True, caption="Image 3")
with col4:
    st.image(load_image('image16.jpeg'), use_column_width=True, caption="Image 4")
...
if uploaded_file is not None:
    user_image = Image.open(uploaded_file)
        ...
        # Load model image
    model_image1 = load_image('image13.jpeg')
    model_image2 = load_image('image14.jpeg')

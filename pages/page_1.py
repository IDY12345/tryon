...
with col3:
    st.image(load_image('image3.jpg'), use_column_width=True, caption="Image 3")
with col4:
    st.image(load_image('image4.jpg'), use_column_width=True, caption="Image 4")
...
if uploaded_file is not None:
    user_image = Image.open(uploaded_file)
        ...
        # Load model image
    model_image1 = load_image('image1.jpg')
    model_image2 = load_image('image2.jpg')
...
with subcol2:
    st.image(load_image('image17.jpeg'), use_column_width=True, caption="Image 2")
